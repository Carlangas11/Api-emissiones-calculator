...
export class NivelesService {
  ...
  async seedLvl1(): Promise<string> {
    ...
    try {
      ...
      return 'Seed nivel1 executed successfully'
    } catch (error) {
  ...
  async seedLvl2(): Promise<string> {
    ...
    for await (const registro of nivel2) {
    ...
    try {
        ...
        return 'Seed nivel2 executed successfully'
    } catch (error) {
  ...
  async seedLvl3(): Promise<string> {
    ...
    for await (const registro of nivel3) {
  ...
  async seedLvl4(): Promise<string> {
    ...
    for await (const registro of nivel4) {
      const nivel2 = await this.nivel2Model.findOne({ name: registro.nivel2 })
      if (nivel2) {
        registro.nivel2 = nivel2._id
      }
    ...
    try {  
        ...
        return 'Seed nivel4 executed successfully'  
    } catch (error) {
  ...
  async seedContaminantes(): Promise<string> {
    ...
    for await (const registro of contaminantes) {
      const nivel2 = await this.nivel2Model.findOne({ name: registro.nivel2 })
      if (nivel2) {
        registro.nivel2 = nivel2._id
      }
    ...
    try {
        ...
        return 'Seed contaminantes executed successfully'
    } catch (error) {
